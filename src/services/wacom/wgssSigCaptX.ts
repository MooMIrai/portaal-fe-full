...
/*var JSONreq = {  
    ...
    getJSON: function(url, data, callback) {
      ...
      data["callback"] = "window["JSONreq"].success";
...
export function WacomGSS_SignatureSDK(_onDetectRunning:any, service_port:any)
{
  this.running = false;
  this.session = null;
  ...
  this.keepAlive = function()
  {
    ...
    window["JSONreq"].getJSON(server_url + "wacom.js", data, function (){});
  ...
  function onGetPort(server_data) 
  {
    if(0 == server_data.status) 
    {
      ...
      window["JSONreq"].getJSON(server_url + "wacom.js", data, onGetSession)
    } 
    else 
    {
  ...
  {
    var data = { "GetPort": 1 };
    window["JSONreq"].getJSON(server_url + service_port + "/wacom.js", data, onGetPort);
  }
  checkService();
  ...
  this.getVersion = function(_onGetVersion) {
    ...
    window["JSONreq"].getJSON(server_url + "wacom.js", data, callback);
  }
  ...
  this.WizCtl = function(_onConstructor)
  {
    ...
    this.SetEventHandler = function(eventHandler)
    {
      ...
      function callback(server_data)
      {
        ...
        {
          window["JSONreq"].getJSON(server_url + "wacom.js", update_data, callback);
        }
